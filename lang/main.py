...
script = """
// Test 1: 기본 선 그래프 및 주요 옵션
그래프생성 "월별 수익"
종류는 선그래프
제목은 "2024년 월별 수익 현황 (백만원)"
데이터는 [[1, 2, 3, 4, 5, 6], [10, 12, 15, 13, 17, 20]]
...
그래프의 배경색은 회색
그래프의 내부 배경색은 흰색
그래프의 투명도는 0.9 // 출력 옵션의 투명도
그래프 크기는 [800, 600] // 출력 옵션
해상도는 200 // 출력 옵션
파일로 저장 = "월별수익_선그래프.png" // 출력 옵션
